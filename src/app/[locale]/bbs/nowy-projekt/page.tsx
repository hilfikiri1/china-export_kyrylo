...
export const metadata: Metadata = {
  title: "New client project — B&BS Admin",
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      <div className="mb-7">
        ...
        <h1 className="mt-2 text-2xl font-bold text-white">{ru ? "Новый проект клиента" : "Nowy projekt klienta"}</h1>
        <p className="mt-1 text-sm text-white/50">
          {ru ? "Создайте проект в Notion и постоянную ссылку на кабинет клиента." : "Utwórz projekt w Notion i stały link do panelu klienta."}
        </p>
        <Link href={`/${locale}/bbs/projekty`} className="mt-3 inline-block text-xs text-accent-light/80 underline">
          {ru ? "Посмотреть и редактировать существующие проекты" : "Zobacz i edytuj istniejące projekty"}
        </Link>
      </div>
