  ...
  return (
    <section className="relative mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
      ...
      <p className="mt-4 max-w-prose text-base leading-relaxed text-white/60">
        Dostęp do panelu klienta jest możliwy poprzez indywidualny, bezpieczny
        link otrzymany od opiekuna projektu.
      </p>

      <div className="mt-8 rounded-2xl border border-white/10 bg-navy-light p-6">
        <p className="text-sm leading-relaxed text-white/70">
          Jeśli jesteś naszym klientem i nie otrzymałeś jeszcze linka do swojego
          projektu, skontaktuj się bezpośrednio ze swoim opiekunem lub napisz na{" "}
          <a
      ...
      {process.env.NODE_ENV === "development" && (
        <div className="mt-10 rounded-lg border border-yellow-500/20 bg-yellow-500/5 px-4 py-3">
          <p className="text-xs text-yellow-400/70">
            <strong className="text-yellow-400">Dev only:</strong> Demo projekt:{" "}
            <a
