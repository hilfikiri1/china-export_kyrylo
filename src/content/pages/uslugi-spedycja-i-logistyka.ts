...
export const spedycjaILogistykaPage: DedicatedPageContent = {
  ...
  meta: {
    title: "Transport, odprawa i logistyka — Buy & Bring Solutions",
    description:
  ...
  sections: [
    ...
    },
    {
      ...
      body: "Czas tranzytu zależy od portu załadunku, sezonu, warunków przewoźnika i rodzaju transportu. Przedstawiamy orientacyjne przedziały dopasowane do konkretnego projektu.",
    },
  ],
  cta: {
