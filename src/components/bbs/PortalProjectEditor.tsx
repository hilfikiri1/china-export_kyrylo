  ...
  return (
    <form action={action} className="space-y-7">
      ...
      <section className="rounded-2xl border border-white/10 bg-navy-light p-5 sm:p-6">
        <div className="mb-5">
          <h2 className="font-semibold text-white">Stan projektu</h2>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="edit-status" className="text-white/80">Status wewnętrzny</Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-stage" className="text-white/80">Etap klienta</Label>
        ...
        <label className="mt-5 flex cursor-pointer items-start gap-3 text-sm text-white/70">
          ...
          <span>
            <strong className="font-medium text-white/80">Link klienta aktywny</strong>
            <span className="mt-0.5 block text-xs text-white/40">Odznaczenie natychmiast wyłączy dostęp przez /pl/panel/[token].</span>
          </span>
        </label>
      </section>
      ...
      <section className="rounded-2xl border border-white/10 bg-navy-light p-5 sm:p-6">
        <div className="mb-5">
          <h2 className="font-semibold text-white">Aktualizacja dla klienta</h2>
          <p className="mt-1 text-xs leading-relaxed text-white/45">
        ...
        <div className="space-y-2">
          <Label htmlFor="edit-update" className="text-white/80">Opis aktualizacji</Label>
          <Textarea id="edit-update" name="updateDescription" rows={4} maxLength={1500} placeholder="np. Kontrola próbki zakończona. Parametry zgodne ze specyfikacją." className={fieldClassName} />
        </div>

        <div className="mt-4 space-y-2">
          <Label htmlFor="edit-images" className="text-white/80">Zdjęcia</Label>
          ...
          <p className="text-xs text-white/35">Do 3 zdjęć naraz, maks. 2,5 MB każde i 3,2 MB łącznie.</p>
        </div>
        ...
        <label className="mt-4 flex cursor-pointer items-center gap-3 text-sm text-white/70">
          ...
          <span>Pokaż tę aktualizację i zdjęcia klientowi</span>
        </label>
      </section>
      ...
      <Button type="submit" disabled={pending} className="w-full bg-accent-light text-white shadow-lg shadow-accent-light/25 hover:bg-[#dbaa47]">
        {pending ? "Zapisywanie i wysyłanie zdjęć…" : "Zapisz i odśwież panel klienta"}
      </Button>
    </form>
  );
}
